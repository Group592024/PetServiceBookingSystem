    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                ...
                if (petData.flag) {
                    setPet(petData.data);
                    const breedResponse = await fetch(`http://localhost:5010/api/petBreed/${petData.data.petBreedId}`);
                        ...
                        <div className="bg-gray-300 rounded-xl p-8 shadow-lg">
                            <div className="flex flex-col md:flex-row gap-16">
                                ...
                                <div className="md:w-5/12 flex flex-col items-center">
                                    ...
                                    <h1 className="text-4xl font-bold text-gray-800 my-4">{pet.petName}</h1>
                                ...
                                <div className="md:w-6/12">
                                    ...
                                    <div className="mt-8">
                                        <h2 className="font-bold text-gray-800 text-2xl mb-4">Notes</h2>
