                                ...
                                <div className="grid gap-8">
                                    {sortedUserPets.length > 0 ? (
                                        ...
                                        <div className="flex flex-col items-center justify-center py-12 bg-white rounded-xl shadow-md">
                                            ...
                                            <h3 className="text-lg font-medium text-gray-900 mb-1">Service Unavailable</h3>
                                            <p className="text-gray-500">Unable to retrieve your pet health records. Please check your connection or contact us for assistance</p>
                                        </div>
                                    )}
                                </div>
                            </div>
