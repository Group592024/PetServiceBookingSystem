      ...
      try {
        ...
        if (petData.data) {
          const account = accountData.data.find(
            (acc) => acc.accountId === petData.data.accountId
          );
          setAccountName(account ? account.accountName : "Unknown");
          const breed = breedData.data.find(
            (breed) => breed.petBreedId === petData.data.petBreedId
          );
            ...
            <div className="flex flex-col lg:flex-row gap-12">
              ...
              <div className="flex-1">
                <div className="mb-3 flex justify-center">
                  <img
                    src={`http://localhost:5050/pet-service${
                      pet.petImage || "/Images/default-image.png"
                    }`}
                    alt="Pet"
                ...
                <div className="mb-3 flex items-center gap-4 mt-7">
                  <label className="font-bold text-lg text-gray-500 min-w-[120px]">
                    Name:
                  </label>
                  <input
                    type="text"
                ...
                <div className="mb-3 flex items-center gap-4 mt-5">
                  ...
                  <input
                    type="text"
                    className={`flex-1 p-2 font-semibold border rounded-lg bg-gray-200 ${
                      pet.isDelete ? "text-red-500" : "text-green-500"
                    }`}
              ...
              <div className="w-full lg:w-1/2 flex flex-col gap-6">
                ...
                <div className="flex justify-center gap-4 mb-3">
                  <button
                    onClick={() =>
                      navigate(`/customer/pet-diaries/${pet.petId}`)
                    }
