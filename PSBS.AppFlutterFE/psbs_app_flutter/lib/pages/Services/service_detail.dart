...
class _ServiceDetailState extends State<ServiceDetail> {
  ...
  String get imageURL =>
      'http://192.168.1.2:5023${detail['serviceImage'] ?? ''}';
  ...
  Future<void> fetchDetail() async {
    try {
      ...
      final response = await http.get(
        Uri.parse('http://192.168.1.2:5050/api/Service/${widget.serviceId}'),
        headers: {
  ...
  Future<void> fetchVariantData() async {
    try {
      ...
      final response = await http.get(
        Uri.parse(
            'http://192.168.1.2:5050/api/ServiceVariant/service/${widget.serviceId}?showAll=false'),
        headers: {
          "Content-Type": "application/json",
          "Authorization": "Bearer $token",
        },
