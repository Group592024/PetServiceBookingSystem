...
class _AddBookingPageState extends State<AddBookingPage> {
  ...
  Future<void> _fetchPaymentTypes() async {
    try {
      ...
      final response = await http.get(
        Uri.parse('http://127.0.0.1:5115/api/PaymentType'),
        headers: {
  ...
  Future<void> _fetchVouchers() async {
    try {
      ...
      print("Token: $token");
      final response = await http.get(
        Uri.parse('http://127.0.0.1:5022/api/Voucher/valid-voucher'),
        headers: {
          "Authorization": "Bearer $token",
          "Content-Type": "application/json",
        },
  ...
  Future<void> _fetchPetName(String petId) async {
    ...
    try {
      ...
      final response = await http.get(
        Uri.parse('http://127.0.0.1:5010/api/pet/$petId'),
        headers: {
          "Authorization": "Bearer $token",
          "Content-Type": "application/json",
        },
  ...
  Future<String> _fetchVoucherName(String voucherId) async {
    try {
      ...
      final response = await http.get(
        Uri.parse('http://127.0.0.1:5022/api/Voucher/customer/$voucherId'),
        headers: {
          "Authorization": "Bearer $token",
          "Content-Type": "application/json",
        },
  ...
  Future<String> _fetchPaymentTypeName(String paymentTypeId) async {
    try {
      ...
      final response = await http.get(
        Uri.parse('http://127.0.0.1:5115/api/PaymentType/$paymentTypeId'),
        headers: {
          "Authorization": "Bearer $token",
          "Content-Type": "application/json",
        },
