    ...
    public partial class newMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("2e9e9b22-81f8-4cda-900c-5e47d0849b67"), new DateTime(2025, 1, 15, 21, 33, 35, 113, DateTimeKind.Local).AddTicks(5048), "Medical services like vaccinations,...", false, "Medical", new DateTime(2025, 1, 15, 21, 33, 35, 113, DateTimeKind.Local).AddTicks(5077) },
                    { new Guid("b94e2e27-fb58-4419-8c4f-69c58b752eab"), new DateTime(2025, 1, 15, 21, 33, 35, 113, DateTimeKind.Local).AddTicks(5081), "Spa services like grooming,...", false, "Spa", new DateTime(2025, 1, 15, 21, 33, 35, 113, DateTimeKind.Local).AddTicks(5081) }
                });
