...
namespace FacilityServiceApi.Infrastructure.Data
{
    ...
    [Migration("20250212042818_update db that allow null for checkin and checkout Date")]
    partial class updatedbthatallownullforcheckinandcheckoutDate
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("FacilityServiceApi.Domain.Entities.ServiceType", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            createAt = new DateTime(2025, 2, 12, 11, 28, 18, 27, DateTimeKind.Local).AddTicks(6713),
                            description = "Medical services like vaccinations,...",
                            isDeleted = false,
                            typeName = "Medical",
                            updateAt = new DateTime(2025, 2, 12, 11, 28, 18, 27, DateTimeKind.Local).AddTicks(6773)
                        },
                        new
                        {
                            serviceTypeId = new Guid("b94e2e27-fb58-4419-8c4f-69c58b752eab"),
                            createAt = new DateTime(2025, 2, 12, 11, 28, 18, 27, DateTimeKind.Local).AddTicks(6781),
                            description = "Spa services like grooming,...",
                            isDeleted = false,
                            typeName = "Spa",
                            updateAt = new DateTime(2025, 2, 12, 11, 28, 18, 27, DateTimeKind.Local).AddTicks(6782)
                        });
                });
