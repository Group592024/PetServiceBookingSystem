...
namespace FacilityServiceApi.Infrastructure.Data
{
    ...
    [Migration("20250212033554_Update construct db for ServiceItem and Room History")]
    partial class UpdateconstructdbforServiceItemandRoomHistory
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("FacilityServiceApi.Domain.Entities.ServiceType", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            createAt = new DateTime(2025, 2, 12, 10, 35, 53, 594, DateTimeKind.Local).AddTicks(1611),
                            description = "Medical services like vaccinations,...",
                            isDeleted = false,
                            typeName = "Medical",
                            updateAt = new DateTime(2025, 2, 12, 10, 35, 53, 594, DateTimeKind.Local).AddTicks(1628)
                        },
                        new
                        {
                            serviceTypeId = new Guid("b94e2e27-fb58-4419-8c4f-69c58b752eab"),
                            createAt = new DateTime(2025, 2, 12, 10, 35, 53, 594, DateTimeKind.Local).AddTicks(1631),
                            description = "Spa services like grooming,...",
                            isDeleted = false,
                            typeName = "Spa",
                            updateAt = new DateTime(2025, 2, 12, 10, 35, 53, 594, DateTimeKind.Local).AddTicks(1632)
                        });
                });
