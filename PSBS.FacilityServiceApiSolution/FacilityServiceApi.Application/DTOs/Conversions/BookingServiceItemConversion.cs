...
{
    public static class BookingServiceItemConversion
    {
        ...
        public static (BookingServiceItemDTO?, IEnumerable<BookingServiceItemDTO>?) FromEntity(BookingServiceItem? serviceItem, IEnumerable<BookingServiceItem>? serviceItems)
        {
